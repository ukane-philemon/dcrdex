...
type Wallet interface {
	...
	// EstimateWithdrawalFee returns an estimate for the fee needed to either
	// send or withdraw.
	EstimateWithdrawalFee(address string, value, feeRate uint64, send bool) (fee uint64, err error)
}
