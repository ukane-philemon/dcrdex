...
var EnUS = map[string]string{
	...
	"Submit":                         "Submit",
	"Skip Registration":              "Skip Registration (view-only mode)",
	...
	"target_tier_tooltip":            "TThis is the target account tier you wish to maintain. Set to zero if you wish to disable tier maintenance.",
	...
	"enable_bond_maintenance":        "Enable bond maintenance or post a bond from the DEX Settings page.",
	"Buy":                            "Buy",
	"Sell":                           "Sell",
	"lot_size":                       "Lot Size",
	"Rate Step":                      "Rate Step",
