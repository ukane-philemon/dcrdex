...
# posinst is a special filename under the DEBIAN directory. The scirpt will
...
ICON_BUILDPATH="${ICON_BUILDDIR}/${ICON_FILENAME}"
...
# Icon
cp "${SRC_DIR}/${ICON_FILENAME}" "${ICON_BUILDPATH}"
chmod 644 "${ICON_BUILDPATH}"
